 ...
 */
class LocVoiture implements JsonSerializable
{
    /**
     * @var int
     *
    ...
    public function jsonSerialize(): array
    {
        return array(
            'id' => $this->id,
            'pays' => $this->idPays,
            'voiture' => $this->idVoiture,
            'dateRes' => $this->dateRes->format("d-m-Y"),
            'dureeRes' => $this->dureeRes,
            'remise' => $this->remise ? 1 : 0,
            'tauxRemise' => $this->tauxRemise

        );
    }

    public function setUp($pays, $voiture, $dateRes, $dureeRes, $remise, $tauxRemise)
    {
        $this->idPays = $pays;
